...
def heating_turn_on(ValueHeating):
  CountGpio = 0
  print (Last_Speed_Fan_Value) 
  Matrix_Heating_Value = dict_heating_value[ValueHeating]
  if Matrix_Heating_Value[0] ==str(0):
    if Last_Speed_Fan_Value == "00":
      fan_speed(str(30))
    ...
    print("Arret chauffage")
  global Last_Heating_Value
  Last_Heating_Value=str(ValueHeating)
...
def lanceprog():
  while EndProg == 1:
    ...
    print ("Dernières valeurs SF %s et Heating %s" % (Last_Speed_Fan_Value,Last_Heating_Value,) )
